...
const Header: FC<NavbarProps> = (props) => {
    ...
    return (
        <nav className="navbar">
            <a className="nav-link" onClick={() => setPage("daily")} style={dailyActive}>
                <MdSunny className="nav-icon" />
                Daily
            </a>
            <a className="nav-link" onClick={() => setPage("history")} style={historyActive}>
                <MdMenuBook className="nav-icon" />
                History
            </a>
            <a className="nav-link" onClick={() => setPage("settings")} style={settingsActive}>
